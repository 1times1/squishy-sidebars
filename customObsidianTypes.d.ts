...
export interface PluginManager extends CorePluginLoader {
    app: App;
    config: Object;
    migration: Boolean;
...
export class Workspace extends Events {
    ...
    getSideLeaf(side: WorkspaceSidedock | WorkspaceMobileDrawer, split: boolean): WorkspaceLeaf;
